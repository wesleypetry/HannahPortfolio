    ...
    return (
        <div className="container">
            ...
            <div className="casestudy">
                ...
                <p>I took the student client’s wants and needs into consideration as a priority when I was designing this site. After multiple meetings with the client, they were greatly pleased with the result. View the final designs below or click <a className="boldLink" href="http://clemsongc.com/archive/2400F19/hbraswe/final/" target="_blank" rel="noreferrer noopener">here</a> to see the site on your browser.</p>
