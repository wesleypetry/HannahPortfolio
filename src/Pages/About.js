            ...
            <div className="AboutWrapper">
                ...
                <div className="AboutText">
                    ...
                    <div className="aboutparagraph">
                        ...
                        <h2>Contact Me</h2>
                        <p className="email">hbraswe@g.clemson.edu</p>
                    </div>
                </div>
            </div>
        </div>
